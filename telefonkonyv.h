...
public:
     ...
     *
     * @param m A telefonkönyv kezdő mérete (alapértelmezett: 5)
     */
     ...
     *
     * @param masik A másik Telefonkonyv objektum, amelyből másolunk
     */
    ...
    /**
     * @brief A telefonkönyv kapacitásának bővítése.
     *
     * @param sz Az új Személy objektum, amely miatt bővítünk
     */
    void expand(Szemely* sz);

    /**
     * @brief Telefonkonyv osztály egyenlőség operátora.
     *
     * @param masik A másik Telefonkonyv objektum, amelyből hozzárendelünk
